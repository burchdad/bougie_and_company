    ...
    <section className="sunset-band">
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-16 sm:px-6 md:grid-cols-[0.95fr_1.05fr] lg:px-8">
        ...
        <div className="self-center">
          ...
          <h1 className="mt-4 font-display text-5xl leading-tight text-ink sm:text-6xl">Luxury meets country in every detail.</h1>
          <p className="mt-6 text-lg leading-8 text-espresso/75">
            Bougie & Company Boutique was built for customers who love the confidence of a polished boutique experience and the warmth of Texas living. The brand brings together clothing, equine jewelry, home goods, gifts, self-care, men&apos;s products, and women&apos;s products in a clean, luxury mercantile setting.
          </p>
        </div>
      </div>
          ...
          {["Rooted In Texas", "Handpicked Goods", "Boutique Service"].map((item, index) => (
            <div className="editorial-panel rounded-lg border border-saddle/15 p-6 shadow-sm" key={item}>
              ...
              <p className="mt-3 text-sm leading-7 text-espresso/70">
                {index === 0 ? "Inspired by Rusk, Texas and built for customers who love Southern style with a polished finish." : index === 1 ? "Every product is chosen for beauty, usefulness, quality, and the kind of detail that makes it gift-worthy." : "The shopping experience should feel personal, easy to browse, and elevated from the first click to the final package."}
              </p>
            </div>
          ))}
        </div>

...
export const defaultMenuItems: CategoryMenuItem[] = [
  {
    ...
    children: [
      ...
      { label: "Kitchen Collection", href: "/shop#kitchen-selection", children: [{ label: "Dish Soap", href: "/shop#homemade-dish-soap" }, { label: "Foaming Hand Soap", href: "/shop#foaming-hand-soap" }] },
  ...
  { label: "Equine Jewelry", href: "/shop#equine-jewelry", children: [{ label: "Necklaces", href: "/shop#necklaces" }, { label: "Earrings", href: "/shop#equine-earrings" }] },

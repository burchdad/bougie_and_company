...
export function HeaderActions() {
  ...
  return (
    <>
      ...
      {panel ? (
        <div className="fixed inset-0 z-50 bg-ink/45 backdrop-blur-sm" onClick={() => setPanel(null)}>
          <aside className="ml-auto flex h-full w-full max-w-md flex-col bg-ivory shadow-glow" onClick={(event) => event.stopPropagation()}>

        ...
        <div className="grid gap-8 md:grid-cols-[1fr_0.6fr] md:items-end">
          <div>
            ...
            <p className="mt-5 max-w-2xl text-lg leading-8 text-espresso/75">
              Browse live boutique inventory synced from Epos, including clothing, equine jewelry, home goods, bath and body, gifts, men&apos;s care, women&apos;s care, kitchen goods, and accessories.
            </p>
          </div>
          <div className="rounded-lg bg-ink p-6 text-ivory shadow-luxe">
            ...
            <p className="mt-3 font-display text-4xl">Live products, stock, and pricing from the boutique floor.</p>
          </div>
        </div>
        <ShopProducts />
      </div>
